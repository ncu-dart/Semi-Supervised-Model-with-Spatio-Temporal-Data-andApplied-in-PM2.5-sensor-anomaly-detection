...
class MNIST_Dataset(TorchvisionDataset):
    ...
    def __init__(self, root: str, normal_class: int = 0, known_outlier_class: int = 1, n_known_outlier_classes: int = 0,
        ...
        print('train_set.semi_targets[idx]',train_set.semi_targets[idx])
        print('torch.tensor(semi_targets)',torch.tensor(semi_targets))
...
class MyMNIST(MNIST):
    ...
    def __getitem__(self, index):
        ...
        #print('index',index)
        #print('img',img)
        #print('array',self.data[index])
        #print('semi_targets_shape',self.semi_targets.shape)
