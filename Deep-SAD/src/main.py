...
################################################################################
@click.command()
@click.argument('dataset_name', type=click.Choice(['mnist', 'fmnist', 'cifar10', 'arrhythmia', 'cardio', 'satellite''satimage-2', 'shuttle', 'thyroid','PM2_5','PM2_5_mnist',
                                                   'description_data','heatmap','description_plus_timeseries_data','line_chart_all_data']))
@click.argument('net_name', type=click.Choice(['mnist_LeNet', 'fmnist_LeNet', 'cifar10_LeNet', 'arrhythmia_mlp','cardio_mlp', 'satellite_mlp', 'satimage-2_mlp', 'shuttle_mlp',                                          
                                               'thyroid_mlp','PM2_5_mlp','PM2_5_mnist_LeNet','newdata_mlp','description_mlp','heatmap_mlp','description_plus_timeseries_mlp','line_chart_all_mlp']))
...
@click.option('--ratio_known_normal', type=float, default=0.00001,
...
@click.option('--modelname_and_numbers', type=str, default='model1_1',)
def main(dataset_name, net_name, xp_path, data_path, load_config, load_model, eta,
         ...
         num_threads, n_jobs_dataloader, normal_class, known_outlier_class, n_known_outlier_classes,modelname_and_numbers,):
    """
    ...
    # Print paths
    logger.info('modelname and number is %s' % modelname_and_numbers)
    ...
    deepSAD.save_results(export_json=xp_path + '/result_json/' + modelname_and_numbers + '__' + dataset_name + net_name + str(ratio_known_normal) + '_' + str(ratio_known_outlier) + str(ratio_pollution) + 'results.json')
